...
<body>
    ...
    <div class="tolls">
        <div class="toll"><i class="icon fa-solid fa-plus"></i></div>
        <div class="toll"><i class="icon fa-solid fa-trash"></i></div>
        <div class="toll"><i class="icon fa-solid fa-folder-plus"></i></div>
    </div>
    <div class="painel">
        <div class="linha">
            <input type="checkbox" id="NameFile">
